...
import MainImage from '../../images/Pacote de Decoração Boho/DSC07899.jpg';
...
const Beauty = () => {
  ...
  const productName = 'Pacote de Decoração Boho';
  ...
  const handleAddToCart = () => {
    addToCart({ id: 'boho', name: productName, image: MainImage });
      ...
      <main>
        <section className="product-details">
          ...
          <div id="product-description">
            <p>O estilo Boho é marcado por seu toque mais intimista, e pela presença de detalhes que remetem a traços despojados, com uma pitada de sofisticação! A ideia é criar ambientes boêmios contemporâneos, com um mix de tendências modernas e alguns traços vintages! Se você ama um estilo mais despojado e ao mesmo tempo aconchegante, essa decoração vai te surpreender!!</p>
            <h4>Ambientes Disponíveis:</h4>
            <ul>
              <li>Mezanino (Itapema)</li>
              <li>Espaço Panorâmico (Itapema)</li>
              <li>Salão de Eventos (Itapema)</li>
              <li>Lounge (Itapema)</li>
            </ul>
