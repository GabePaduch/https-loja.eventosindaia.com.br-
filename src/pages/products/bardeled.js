...
import MainImage from '../../images/Bar de LED/03.jpeg';
...
const Bardeled = () => {
  ...
  const handleAddToCart = () => {
    addToCart({ id: 'bardeled', name: productName, image: MainImage });
